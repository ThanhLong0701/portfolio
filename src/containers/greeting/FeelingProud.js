...
import avatarImage from '../greeting/thanhlong.jpg'
...
function FeelingProud(props) {
  ...
  return (
    ...
    //   </g>
    // </svg>
<div className="feeling-proud" style={{ background: theme.background, color: theme.color, display:"flex", justifyContent:"center", marginTop:"70px" }}>
      <Avatar src={avatarImage} size={300} alt="Thanhlong" />
